  ...
  methods:{
    jumpHome(){
      try {
        ...
        if(window.WebViewJavascriptBridge){
          this.$bridge.callhandler('goHomePage',null,(data)=>{
            this.$bridge.callhandler("trackEvent","Ac_App_1stanniversary_book");
          });
        }else{
      ...
      switch (who) {
        case "Air":
          try {
            ...
            if(window.WebViewJavascriptBridge){
              this.$bridge.callhandler("trackEvent","Ac_App_1stanniversary_hegcoupons");
            }
          }
          break;
        case "Samsung":
          try {
            ...
            if(window.WebViewJavascriptBridge){
              this.$bridge.callhandler("trackEvent","Ac_App_1stanniversary_pics8phone");
            }
          }
          break;
        case "NETMED":
          try {
            ...
            if(window.WebViewJavascriptBridge){
              this.$bridge.callhandler("trackEvent","Ac_App_1stanniversary_netmeds");
            }
          }
          break;
        case "MYNTRA":
          try {
            ...
            if(window.WebViewJavascriptBridge){
              this.$bridge.callhandler("trackEvent","Ac_App_1stanniversary_mytnra");
            }
          }
          break;
        case "TREEBO":
          try {
            ...
            if(window.WebViewJavascriptBridge){
              this.$bridge.callhandler("trackEvent","Ac_App_1stanniversary_treebo");
            }
          }
          break;
        case "ZOOMCAR":
          try {
            ...
            if(window.WebViewJavascriptBridge){
              this.$bridge.callhandler("trackEvent","Ac_App_1stanniversary_zoomecar");
            }
          }
          break;
        case "XOXODAY":
          try {
            ...
            if(window.WebViewJavascriptBridge){
              this.$bridge.callhandler("trackEvent","Ac_App_1stanniversary_xoxoday");
            }
          }
          break;
        case "GAANA":
          try {
            ...
            if(window.WebViewJavascriptBridge){
              this.$bridge.callhandler("trackEvent","Ac_App_1stanniversary_Gaana");
            }
          }
          break;
        default:
    ...
    jumpToLottery(){
      try {
        ...
        if(window.WebViewJavascriptBridge){
          this.$bridge.callhandler("trackEvent","Ac_App_1stanniversary_lotterybutton");
        }
      }
      ...
      switch (who) {
        case 0:
          try {
            ...
            if(window.WebViewJavascriptBridge){
              this.$bridge.callhandler("trackEvent","Ac_App_1stanniversary_facebook");
            }
          }
          break;
        case 1:
          try {
            ...
            if(window.WebViewJavascriptBridge){
              this.$bridge.callhandler("trackEvent","Ac_App_1stanniversary_Twitter");
            }
          }
          break;
        case 2:
          try {
            ...
            if(window.WebViewJavascriptBridge){
              this.$bridge.callhandler("trackEvent","Ac_App_1stanniversary_Instagram");
            }
          }
          break;
        case 3:
          try {
            ...
            if(window.WebViewJavascriptBridge){
              this.$bridge.callhandler("trackEvent","Ac_App_1stanniversary_google");
            }
          }
          break;
        case 4:
          try {
            ...
            if(window.WebViewJavascriptBridge){
              this.$bridge.callhandler("trackEvent","Ac_App_1stanniversary_youtube");
            }
          }
          break;
        default:
