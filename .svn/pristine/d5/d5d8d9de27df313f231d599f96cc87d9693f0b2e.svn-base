<template>
    <div class="container">
      <div class="filter" :class="{marTop:showHeader}">
      ...
      <div class="list">
        <div class="list-item flex space-between" @click="toDetail(index)"  v-for="(v, index) in newList" :key="v.id">
...
export default {
  ...
  methods: {
    toDetail(index){
      let url = `/hotel_order/order/${this.newList[index].bookingNo}`;
