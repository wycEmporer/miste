		...
		<div class="menu-cont">
			<div class="menu-user flex direction-column content-center align-items-center" :class="{qqClass:isQQ}">
				...
				<div class="user-login">
					...
					<span v-else-if="userInfoSe.userName">{{userInfoSe.userName}}</span>
					<span v-else>
			...
			<div class="menu-list">
				<ul>
					...
					<li class="flex space-between" @click="goMyHotel">
						<span>My Hotels</span>
						<span class="ico"></span>
					</li>
					...
					<li class="flex space-between li-support" @click="$router.push('/support')">
						<span>24<i style="vertical-align:bottom;">*</i>7 Support</span>
						<span class="ico"></span>
					</li>
