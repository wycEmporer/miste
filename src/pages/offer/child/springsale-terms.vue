    ...
    <div class="container">
      ...
      <div class="content">
        <div class="text-group">
          ...
          <div class="line"></div>
          <p>• These coupon codes can be applied with Instant Discount,Cashback and Happy Sliver extended by HappyEasyGo.
          </p>
          <p>• In case of any cancellation/refund (by airline or provider) happens out of the validity of this campaign, your
            coupon will be voided.
          </p>
          <p>
            • HappyEasyGo Travel Pvt. Ltd. ("HappyEasyGo") reserves the right to add, alter, modify all or any of Spring Break Sale promotion,
            or replace wholly or in part, this offer by any other offer, whether similar to this offer or not, without prior
            notice.
          </p>
          <p>• All other standard terms and conditions available at HappyEasyGo.com shall apply.
          </p>
          <p>
