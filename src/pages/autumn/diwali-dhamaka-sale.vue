...
export default {
  ...
  data(){
    return {
      ...
      orderAmount:[
        {id:0,amount1:650,amount2:600,range1:"4000"},
        {id:1,amount1:750,amount2:700,range1:"4000-5999"},
        {id:2,amount1:850,amount2:800,range1:"6000-9999"},
        {id:3,amount1:1150,amount2:950,range1:"10K+"},
      ],
      s1Banners:[],
      s3Shares:[
      ...
      sharesApp:[
        {id:0,name:"SMS",href:"javascript:;",href2:"javascript:;",icon:require('../../assets/images/autumn/diwali-icon-sms.png'),text:'Planning a trip this festive season? Get Rs.1000 off on flights with HappyEasyGo Diwali Sale. Book tickets before 10 Nov. http://bit.ly/2Eqw0ux'},
        {id:1,name:"WhatsApp",href:"javascript:;",action:'share/whatsapp/share',icon:require('../../assets/images/autumn/diwali-icon-whatsapp.png'),text:'Want to save money on flight tickets? Book during HappyEasyGo Diwali Sale and enjoy Rs.1000 off. Offer valid till 10 Nov, 2018. http://bit.ly/2J4AHJ6'},
        {id:2,name:"Messenger",href:"javascript:;",icon:require('../../assets/images/autumn/diwali-icon-fb.png'),text:'It’s the best time to plan a holiday! HappyEasyGo is offering Rs.1000 off on flights during Diwali Sale. Book before 10 Nov, 2018. http://bit.ly/2AgHI7b'},
        {id:3,name:"More",href:'javascript:;',icon:require('../../assets/images/autumn/diwali-icon-more.png'),text:'Planning a trip? Get Rs.1000 off on your flight during HappyEasyGo Diwali Sale. Offer valid till 10 Nov. http://bit.ly/2ySp43F'},
      ]
    }
  },
  methods:{
