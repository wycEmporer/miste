...
export default {
  ...
  data(){
    return {
      ...
      sharesApp:[
        {id:0,name:"SMS",href:"javascript:;",href2:"javascript:;",icon:require('../../assets/images/autumn/share_sms.png'),text:'HappyEasyGo invites you to book flight during HappyEasyGo Autumn Sale. Get upto Rs.800 off & win FREE TICKET, ecash & voucher. https://goo.gl/TzYwjJ'},
        {id:1,name:"WhatsApp",href:"javascript:;",action:'share/whatsapp/share',icon:require('../../assets/images/autumn/share_whatsapp.png'),text:'HappyEasyGo invites you to grab flights at up to Rs.800 off & win FREE TICKET, ecash & HEG voucher during Autumn Sale. https://goo.gl/TzYwjJ'},
        {id:2,name:"Messenger",href:"javascript:;",icon:require('../../assets/images/autumn/share_msg.png'),text:'HappyEasyGo invites you to get up to Rs.800 off & win FREE TICKET, ecash & vouchers during Autumn Season Sale. https://goo.gl/TzYwjJ'},
        {id:3,name:"More",href:'javascript:;',icon:require('../../assets/images/autumn/share_more.png'),text:'HappyEasyGo invites you to get up to Rs.800 off & win FREE TICKET, ecash & more with HappyEasyGo Autumn Sale. https://goo.gl/TzYwjJ'},
      ]
    }
  },
  methods:{
