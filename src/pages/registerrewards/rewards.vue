      ...
      <div class="section2">
        ...
        <div class="s2-left flex space-between">
          <div>
            ...
            <p class="s2-p2">Win <span>1000</span> Happy Silver</p>
          </div>
      ...
      <div class="section3">
        <div class="s3-div1 flex space-between">
          <div class="s2-left">
            ...
            <p>Win <span>800</span> Happy Silver</p>
          </div>
          <div class="s2-right">
...
export default {
  ...
  methods:{
    ...
    getImg() {
      let parmTop = "type=13&device=" + this.model + "&addr=registration-reward&businessType=1";
