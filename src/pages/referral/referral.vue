	...
	<div class="wrapper">
      ...
      <div class="link_phone" v-if="isShowBtn">
        ...
        <div class="download">
          ...
          <a v-show="isShowBtn" target="_blank" class="android_load" href="https://app.adjust.com/vbzvaj?campaign=M&adgroup=Download&creative=Online">
            <img :src='require("../../assets/images/referral/android_load.png")' alt="" name="">
          </a>
          <a v-show="isShowBtn" target="_blank" class="apple_load" href="https://app.adjust.com/vbzvaj?campaign=M&adgroup=Download&creative=Online">
      ...
      <div class="section3">
        ...
        <div class="s3-div s3-divs">
          ...
          <p class="s3-tip1"><span>Tier 1 :</span> After registering with HappyEasyGo using your referral code, if any of your friends or family books a flight ticket with HappyEasyGo within the next one month, you win a reward of <router-link to="/wallet">{{gold3}} Happy Gold</router-link>.</p>
          <p class="s3-tip1"><span>Tier 2 :</span> If someone recommended by your friend or family books flight tickets with HappyEasyGo within the next one month, you earn <router-link to="/wallet">{{gold4}} Happy Gold</router-link>. </p>
        </div>
        <div class="s3-note">
