<template>
	<div class="fareDetail">
		...
		<ul class="fareList" v-if="showFareInfo">
...
export default {
	...
	created(){
		if(sessionStorage.orderInsurance){
			let insurance = JSON.parse(sessionStorage.getItem("orderInsurance"));
			if(insurance.length > 0){ 
				this.showFareInfo = true;
			}else{
				this.showFareInfo = false;
			}
		}
	},
	methods: {
